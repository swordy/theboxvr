...
**Usage:**
```bash
bash /home/user/theboxvr/.claude/skills/visual-explainer/scripts/share.sh <html-file>
```

**Example:**
```bash
bash /home/user/theboxvr/.claude/skills/visual-explainer/scripts/share.sh ~/.agent/diagrams/my-diagram.html
